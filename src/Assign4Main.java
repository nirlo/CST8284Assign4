 ...
 * Purpose:  This class drives the menu for Assignment 2 - Inventory system
 * ****updated to add Read from file and Write to file menu options
 *
 ***********************************************************************************************/
...
public class Assign4Main {
	...
	public static void main (String [] args) {
		...
		Inventory company = new Inventory(1000);
